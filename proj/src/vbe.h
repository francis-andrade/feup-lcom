 ...
 */
/*@{*/
#define VBE_RETURN_CONTROLLER 0x00
#define VBE_RETURN_MODE 0x01
#define VBE_SET_MODE 0x02
/*@}*/

/**
 * @name VBE RETURN STATUS
 */
/*@{*/
 ...
 */
/*@{*/
#define VBE_MODE_LINEAR_BIT  14
#define VBE_GRAPHIC_MODE 0x105
#define VBE_117_MODE 0x117
#define VBE_565_MODE 0x11A
/*@}*/
...
typedef struct {
  /**
   *  @name Mandatory information for all VBE revisions
   */
	/*@{*/
...
/*@}*/
  ...
  /**
   * @name Mandatory information for VBE 1.2 and above
   */
  /*@{*/
  ...
  /*@}*/
  /**
   *  @name Direct Color fields (required for direct/6 and YUV/7 memory models)
   */
  /*@{*/
  ...
  /*@}*/
  /**
   *  @name Mandatory information for VBE 2.0 and above
   */
  /*@{*/
  ...
  /*@}*/
  /**
   *  @name Mandatory information for VBE 3.0 and above
   */
  /*@{*/
...
*/
typedef struct{
	uint8_t VbeSignature[4]; /**< @brief VBE Signature*/
	uint16_t VbeVersion; /**< @brief VBE Version*/
	...
	uint16_t OemSoftwareRex; /**< @brief VBE implementation Software revision*/
	...
	uint8_t Reserved[222]; /**< @brief Reserved for VBE implementation scratch*/
...
/**
 * @brief Returns information on the controller
 *
 *
 * @param vmi_p variable where the controller information should be stored
 *
 * @return 0 on success, non-zero otherwise
 */
